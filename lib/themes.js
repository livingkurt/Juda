...
export const themes = [
  {
    ...
    colors: {
      light: {
        ...
        tagColors: [
          // Pastel row
          "#a5b4fc", "#c4b5fd", "#f9a8d4", "#fca5a5", "#fdba74", "#fcd34d", "#fde047", "#bef264", "#86efac", "#5eead4", "#67e8f9", "#93c5fd", "#ffffff",
          // Normal row
          "#6366f1", "#8b5cf6", "#ec4899", "#ef4444", "#f97316", "#f59e0b", "#eab308", "#84cc16", "#22c55e", "#14b8a6", "#06b6d4", "#3b82f6", "#9ca3af",
          // Dark row
          "#3730a3", "#5b21b6", "#9d174d", "#991b1b", "#9a3412", "#92400e", "#854d0e", "#4d7c0f", "#166534", "#115e59", "#155e75", "#1e40af", "#333333",
        ],
      },
      dark: {
        // Background Colors

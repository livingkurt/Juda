...
export const REFLECTION_TEMPLATES = {
  weekly: [
    ...
    { question: "Progress on this week's focus", order: 3, linkedGoalType: "weekly" },
    { question: "Challenge I faced and how I handled it", order: 4 },
    {
      question: "One thing I want to focus on next week",
      order: 5,
      allowGoalCreation: true,
      goalCreationType: "next_week",
    },
  ],
  monthly: [

...
export const TAB_NAMES = ["tasks", "goals", "journal", "notes", "progress", "workout", "kanban", "history"];
export const TAB_INDICES = { tasks: 0, goals: 1, journal: 2, notes: 3, progress: 4, workout: 5, kanban: 6, history: 7 };

...
export const TAB_NAMES = ["tasks", "goals", "journal", "notes", "progress", "workout", "sleep", "list", "kanban", "history"];
...
const formatDateForUrl = isoString => {
  ...
  // Convert the stored ISO string to a local date string (YYYY-MM-DD)
...
export const URL_STATE_CONFIG = {
  ...
  listView: {
    reduxKey: "listViewMode",
    serialize: value => (value === "templates" ? null : value),
    deserialize: value => value || "templates",
    defaultValue: "templates",
    activeTabs: [7],
  },

  listTemplate: {
    reduxKey: "selectedListTemplateId",
    serialize: value => value || null,

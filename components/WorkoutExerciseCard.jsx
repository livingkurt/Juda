 ...
 * @param {Function} onSetComplete - (exerciseId, setNumber) => void - Called when a set is completed
 */
const WorkoutExerciseCard = memo(
  forwardRef(function WorkoutExerciseCard(
    { exercise, completionData = {}, onSetToggle, currentWeek = 1, onActualValueChange, onSetComplete },
    ref
  ) {
    const setRefs = useRef({});

    // Expose scrollToSet method to parent
                  ...
                  {Array.from({ length: exercise.sets }, (_, i) => {
                    ...
                    return (
                      <Stack
                        ...
                        spacing={1}
                        alignItems="center"
                        sx={{ width: 80, minHeight: 60 }}
                        ref={el => (setRefs.current[setNumber] = el)}
                      >
